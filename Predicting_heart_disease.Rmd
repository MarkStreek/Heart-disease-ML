...
ggplot(ROC.data, aes(x = False_Positive_Rate, y = True_Positive_Rate)) + 
  ...
  annotate("text", x=0.50, y=0.55, label= "Area_Under_AOC: 0.8983.", color = "orange")
```
...
We have now discovered the best concept with the best attributes. We are now going to make our model public by building a Java application around it. This will be done in another repo.
