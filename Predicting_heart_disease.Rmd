...
The cholesteral attribute is good normal distributed now. ST.depression is not good normal distributed but is more readable. However, in ST.depression there is a high peak at - infinity. The attribute is still not normally distributed, so it is left behind for the transformation.
...
The results show that the age is slightly higher in the presence group. It can be concluded that patients with a presence-condition are often
slightly older. The Max.HR is also higher in the absence group. And ST.depression is higher in the Presence group. 
...
The attribute thallium is most related to disease. This value is going to be important for the model. The list if followed by chest pain type. The FBS value over 120 will be the least useful
