...
11. CostSensitiveClassifier with a cost of 4 for Fals Negatives
...
unique(Results$Key_Dataset)

Dataset = c("01-Clean_dataset", "02-top5_p_values", "03-Numeric_transformed", "04-Simple")


cbind(Results$Key_Dataset, Results$mean)
...
#  ),
#  means = c(
#    Results$mean[Results$Key_Scheme %like% "NaiveBayes"],
#    Results$mean[Results$Key_Scheme %like% "SMO"],
#  )
#)
#
#ggplot(x, aes(y = means)) + geom_bar()
```
