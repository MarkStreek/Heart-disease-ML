...
Voordat er een machine learning model ontwikkeld kan worden, moeten er nog twee stappen worden uitgevoerd met de data. Om te beginnen is de eerste kolom verwijderd. Verder worden een aantal attributen omgezet in een label, dit om de dataset overzichterlijker en leesbaarder te maken.
