...
- Add some proper english/conclusions -> link: https://www.health.harvard.edu/heart-health/angina-symptoms-diagnosis-and-treatments
- Tussen twee nominale waardes: kruistabel en/of Chi^2 toets

```{=tex}
\begin{thebibliography}{9}

\bibitem{exercise_induced_angina}
Cancer Statistics (2020, 25 september).: \textit{National Cancer Institute}.

\end{thebibliography}
```

cite: apa bron generator.
