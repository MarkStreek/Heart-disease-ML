...
codebook <- data.frame(
  ...
  dtype = c("int","int","factor","factor","int","int","factor","factor","int","factor","int","factor","factor","factor","factor"),
...
Identifying possible outliers with a boxplot

```{r}
boxplot(data[numeric.columns[1:4]], horizontal = T, las = 2)
```
