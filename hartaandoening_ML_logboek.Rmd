...
ggpairs( data[c(1,4,5,6,8,10,12)+1], ggplot2::aes(colour=data$Heart.Disease))

```

```{r}
colMA <- function(n = 3) {
  colorRampPalette(c("red", "lightgreen"), space = "rgb")(n)
}

library(ggcorrplot)
 
# plotting corr heatmap
ggcorrplot(cor(data[c(1,4,5,6,8,10,12)+1]), colors = colMA(), 
